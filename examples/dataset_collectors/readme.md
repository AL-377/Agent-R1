...
| Level   | 考察能力 | 采样逻辑                       | 示例                |
| ------- | ---- | -------------------------- | ----------------- |
| Level 1 | 状态追踪 | 当前会话 working 层             | "患者今天反馈头晕持续了多久？"  |
| Level 2 | 精准检索 | 长期 identity/history 层      | "患者三个月前使用的降压药名称？" |
| Level 3 | 长程理解 | history + working 跨层       | "对比半年前，空腹血糖波动趋势？" |
| Level 4 | 冲突检查 | working + identity/history | "新开药物是否与过敏史冲突？"   |
