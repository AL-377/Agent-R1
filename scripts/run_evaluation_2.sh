...
python examples/eval/eval_medmem.py \
    ...
    --output_dir eval_results/cmtmedqa_ps_gpt5 \
...
python examples/eval/eval_medmem.py \
    ...
    --output_dir eval_results/cmtmedqa_ns_gpt5 \
    --model gpt-5-2025-08-07 \
    --workers 16
...
python examples/eval/eval_medmem.py \
    ...
    --output_dir eval_results/huatuo26m_ps_gpt5 \
    --model gpt-5-2025-08-07 \
    --judge_model gpt-oss-120b \
    --workers 16
...
python examples/eval/eval_medmem.py \
    ...
    --output_dir eval_results/huatuo26m_ns_gpt5 \
    --model gpt-5-2025-08-07 \
    --workers 16
...
python examples/eval/eval_medmem.py \
    ...
    --output_dir eval_results/meddialog_cn_ps_gpt5 \
    --model gpt-5-2025-08-07 \
    --judge_model gpt-oss-120b \
    --workers 16
...
python examples/eval/eval_medmem.py \
    ...
    --output_dir eval_results/meddialog_cn_ns_gpt5 \
    --model gpt-5-2025-08-07 \
    --workers 16