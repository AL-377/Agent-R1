"""
Convert Huatuo-26M examiner-processed data into swalm RL training format.

Usage:
    python examples/data_preprocess/huatuo26m_memory_rl.py \
        --input_dir datasets/huatuo26m/.examiner_cache \
        --output datasets/huatuo26m/huatuo26m_memory_rl.parquet

    # Generate only specific splits:
    python examples/data_preprocess/huatuo26m_memory_rl.py \
        --input_dir datasets/huatuo26m/.examiner_cache \
        --output datasets/huatuo26m/huatuo26m_memory_rl.parquet \
        --splits pure_summary layers_summary
"""
...
DATA_SOURCE = "memory/huatuo26m"


def main():
    parser = argparse.ArgumentParser(
        description="Convert Huatuo-26M examiner data to swalm RL format"
    )
    parser.add_argument(
